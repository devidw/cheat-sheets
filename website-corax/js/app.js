...
let about = new Vue({
  ...
  data: {
    ...
    blocks: [{
        ...
        Die Kombination der beiden ursprünglichsten Materialien die die Natur hervorgebracht hat, machen unsere Möbelstücke einzigartig und langlebig. Versprochen.'
      },
      {
  ...
  data: {
    ...
    blocks: [{
      ...
      },
      {
        ...
        Diese beinhaltet die Corax Care Instructions - eine ausführlich Pflegeanleitung. Mit einem Reinigungspad für Verunreinigungen am Holz, einem Naturölfläschchen und einem Stofftuch kannst du von Zeit zu Zeit deine Möbel nachölen und kleine Ausbesserungen vornehmen.'
      },
    ]
  }
});
